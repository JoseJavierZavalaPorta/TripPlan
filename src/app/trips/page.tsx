  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link
          href="/trips/new"
          className="h-11 px-4 bg-sky-400 text-navy-900 font-bold text-sm rounded-xl flex items-center gap-2 active:scale-95 transition-transform"
        >
      ...
      {trips.length === 0 ? (
        <div className="text-center py-20">
          ...
          <h2 className="text-white font-semibold text-lg mb-2">Tu próxima aventura te espera</h2>
          <p className="text-slate-400 text-sm mb-8 max-w-xs mx-auto">
            Crea tu primer viaje y empieza a planificar con tu grupo usando IA.
          </p>
          <Link
            href="/trips/new"
            className="inline-flex h-12 px-6 bg-sky-400 text-navy-900 font-bold text-sm rounded-xl items-center gap-2 active:scale-95 transition-transform"
          >
