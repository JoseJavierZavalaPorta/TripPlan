  ...
  return (
    <div className="min-h-dvh bg-sand-50 flex flex-col items-center justify-center px-6 py-12">
      ...
      <div className="mb-10 text-center">
        ...
        <h1 className="text-2xl font-bold text-slate-900">TripPlan</h1>
      ...
      <form onSubmit={handleLogin} className="w-full max-w-sm space-y-4">
        ...
        <div>
          <label htmlFor="password" className="text-sm font-semibold text-slate-700 block mb-1.5">
            Contraseña
          </label>
        ...
        <p className="text-center text-slate-500 text-sm">
          ¿No tienes cuenta?{' '}
          <Link href="/auth/register" className="text-sky-500 font-semibold hover:text-sky-600">
            Regístrate
          </Link>
        </p>
      </form>
